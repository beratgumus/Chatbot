...
public class MobilePhone extends ConsumerElectronics {
    ...
    public MobilePhone(String id, String brand, String model, Double price, Double height, Double width, Double depth, Double weight, Double reviewPoint, Double screenSize, int storageSize, int cameraResolution, String os, int ramSize) {
